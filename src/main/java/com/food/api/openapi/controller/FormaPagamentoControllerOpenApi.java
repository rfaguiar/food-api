...
public interface FormaPagamentoControllerOpenApi {
    ...
    ResponseEntity<FormaPagamentoResponse> buscar(@ApiParam(value = "ID de uma forma de pagamento", example = "1")
    ...
    FormaPagamentoResponse cadastrar(@ApiParam(name = "corpo", value = "Representação de uma nova forma de pagamento")
    ...
    FormaPagamentoResponse atualizar(@ApiParam(value = "ID de uma forma de pagamento", example = "1")
                                     Long formaPagamentoId,
