...
public class AuthorizedClientsController {
    ...
    public AuthorizedClientsController(OAuth2AuthorizationQueryService oAuth2AuthorizationQueryService,
        ...
        this.oAuth2AuthorizationQueryService = oAuth2AuthorizationQueryService;
