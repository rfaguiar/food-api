...
public interface CidadeControllerV2OpenApi {
    ...
    CidadeResponseV2 porId(@Parameter(name = "ID de uma cidade", example = "1", required = true)
                                   Long cidadeId);
    ...
    CidadeResponseV2 adicionar(@Parameter(name = "corpo", description  = "Representação de uma nova cidade", required = true)
    ...
    CidadeResponseV2 atualizar(@Parameter(name = "ID de uma cidade", example = "1", required = true)
                                       Long cidadeId,
