...
public interface CozinhaControllerV3OpenApi {
    ...
    CozinhaResponseV3 porId(@ApiParam(value = "ID de uma cozinha", example = "1", required = true)
                                    Long cozinhaId);
    ...
    CozinhaResponseV3 atualizar(@ApiParam(value = "ID de uma cozinha", example = "1", required = true)
                                        Long cozinhaId,
